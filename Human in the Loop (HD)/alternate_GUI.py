...
# Create widgets
Forward = Button(win, text='Forward Park', font=myFont, command=set_forward_park, highlightbackground='#9898F5', height=3, width=15)
Reverse = Button(win, text='Reverse Park', font=myFont, command=set_reverse_park, highlightbackground='orange', height=3, width=15)
Parallel = Button(win, text='Parallel Park', font=myFont, command=set_parallel_park, highlightbackground='red', height=3, width=15)
